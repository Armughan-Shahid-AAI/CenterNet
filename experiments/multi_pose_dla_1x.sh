...
python main.py multi_pose --exp_id multipose_dla_1x --dataset coco_hp --batch_size 8 --master_batch 8 --lr 5e-4  --gpus 0 --num_workers 2 --load_model ../models/multi_pose_dla_1x.pth
